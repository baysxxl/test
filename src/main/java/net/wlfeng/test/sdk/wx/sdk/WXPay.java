...
public class WXPay {
    ...
    public WXPay(final WXPayConfig config, final String notifyUrl, final boolean autoReport, final boolean useSandbox) throws Exception {
        ...
        if (useSandbox) {
            this.signTypeEnum = SignTypeEnum.MD5; // 沙箱环境
        }
        else {
            this.signTypeEnum = SignTypeEnum.HMACSHA256;
        }
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getKey(), this.signTypeEnum));
        return reqData;
    }
    ...
    public boolean isResponseSignatureValid(Map<String, String> reqData) throws Exception {
        ...
        return WXPayUtil.isSignatureValid(reqData, this.config.getKey(), this.signTypeEnum);
    }
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, String> reqData) throws Exception {
        ...
        if (signTypeInData == null) {
            ...
            if (signTypeInData.length() == 0) {
                ...
                signTypeEnum = SignTypeEnum.HMACSHA256;
            }
            else {
                throw new Exception(String.format("Unsupported sign_type: %s", signTypeInData));
            }
        }
        return WXPayUtil.isSignatureValid(reqData, this.config.getKey(), signTypeEnum);
    }
     ...
     * @return
     */
    public Map<String, String> buildJsApiStr(String prepayId) throws Exception {
        ...
        result.put("paySign", WXPayUtil.generateSignature(result, config.getKey(), this.signTypeEnum));
        return result;
    }
